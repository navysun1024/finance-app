...
export function useFinance() {
 ...
 const addProduct = async (name: string, type: ProductType, note: string = '', code: string = '', holder: string = '') => {
 ...
 const updateProduct = async (id: string, name: string, type: ProductType, note: string = '', code: string = '', holder: string = '') => {
